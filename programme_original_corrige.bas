' programme en qbasic base sur le magazine science et vie junior no 35 (version initiale + correction avec la version 3.40)
...
For i = 1 To 4:
    ' la correction "P="
    P = P + TS(XO + Val(Right$(A$(S, K, i), 1)), YO - 9 + Val(Left$(A$(S, K, i), 1))):
Next i:
